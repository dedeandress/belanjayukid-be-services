...
trait TransactionRepository {
  ...
  def getAllTransactionWithLimit(limit: Int, status: Int): Future[TransactionsResult]

  def updateTotalPrice(transactionId: UUID, transactionDetailStatus: Int): Future[BigDecimal]
